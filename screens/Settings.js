  ...
  return (
    <View style={styles.container}>
      <ScrollView style={styles.formContainer}>
        <TextInput value={"Kamil"} editable={false} style={styles.input} placeholder="Ad" />
        <TextInput value={'Abiyev'} editable={false} style={styles.input} placeholder="Soyad" />
        <TextInput value={'kamilabiyev1903@gmail.com'} style={styles.input} keyboardType={'email-address'} placeholder="E-mail" />
        <Pressable onPress={() => {
          setShow(true)
          console.log(show)
        }} >
          <TextInput value={'1001 - 01 - 01'} selectTextOnFocus={false} style={styles.input} placeholder="Təvəllüd" />
        </Pressable>
        {show && (
          <DateTimePicker
        ...
        <View style={styles.dropdownContainer}>
          ...
          />
          <TextInput value={'111111'} editable={false} style={styles.inputDropdown} keyboardType={'number-pad'} placeholder="Ş.V nömrəsi" />
        </View>
        <View style={styles.dropdownContainer}>
          <DropDownPicker
            items={itemsForNum}
          ...
          />
          <TextInput value={'11111111'} style={styles.inputDropdown} keyboardType={'number-pad'} placeholder="Telefon" />
        </View>
        <TextInput editable={false} value={'1j1j1j1'} style={styles.input} placeholder="FİN Kod" />
        <TextInput value={'Popular belief, Lorem Ipsum is not simply random text'} style={styles.input} placeholder="Ünvan" />
